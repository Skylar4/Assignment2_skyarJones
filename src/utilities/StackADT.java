...
public interface StackADT<E> extends Serializable
{
	 ...
	 * 
         *  **Pre-condition:** The provided array must not be null.
         *  **Post-condition:** The stack remains unchanged.
         * 
	 ...
	 * 
         * Pre-condition:** None.
         * Post-condition:** The stacks remain unchanged.
         * 
	...
	public int size();
	 ...
	 /**
         * Checks if the stack is at capacity (overflow).
         *
         * **Pre-condition:** A fixed-size stack implementation must be used.
         * **Post-condition:** The stack remains unchanged.
         *
